...
/**
 * @minions-content-research/cli — CLI for Minions Content-research
 *
...
import { customTypes } from '@minions-content-research/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Content-research'));
        console.log(chalk.dim('Research sources, topic clusters, keyword sets, and content briefs'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-content-research/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-content-research/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-content-research')}`);
